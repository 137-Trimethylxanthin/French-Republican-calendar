...
def revulutionsDays():
    day = ['Primidi', 'Duodi', 'Tridi', 'Quartidi', 'Quintidi','Sextidi', 'Septidi', 'Octidi', 'Nonidi', 'Decadi']
...
def revulutionsTime():
    ...
    timeDeRevulution = int((getTime.hour * 3600 + getTime.minute * 60 + getTime.second)//0.864)        
...
def asking():
    ...
    if ask.lower() == 'cli'or ask.lower()=='c':
        ...
        print(' ')
        print(' ')
        print(f'the day is: {days}  this month is: {months}    {roman}|{years}  years of freedom', sep='')
    ...
    if ask.lower() == 'gui'or ask.lower()=='g':
        ...
        layout = [  [sg.Text('Revolution', expand_y=True)],
                    ...
                    [sg.Text('Time: ', expand_y=True), sg.Text('', key='_time_', expand_y=True)],
                    [(sg.Quit())]
                    ]
        ...
        window = sg.Window('Revolution',size=(500,300), element_justification='center').Layout(layout)
